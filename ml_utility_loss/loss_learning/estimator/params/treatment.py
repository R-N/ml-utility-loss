...
PARAM_SPACE = {
    ...
    "g_loss_mul": ("log_float", 1e-5, 2e-2),
    # Common model args
...
BEST = {
    'epochs': 924,
    'lr': 0.005159717818203781,
    'Optim': 'padam',
    'loss_balancer_beta': 0.9086033956751818,
    'loss_balancer_r': 0.9854101957926211,
    ...
    'g_loss_mul': 1.2568787212070734e-05,
    'd_model_exp_2': 6,
    'dropout_bool': False,
    'grad_clip': 2.0334703719485296,
    'bias': False,
    'bias_final': False,
