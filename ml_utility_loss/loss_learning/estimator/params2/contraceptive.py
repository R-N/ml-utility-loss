...
#GOOD = [1, 2]
GOOD = [0, 1]
#[0.004660645150579512, 0.002932871284428984]
BEST = {
    **DEFAULTS,
    'loss_balancer_meta_boolc': True,
    'loss_balancer_beta': 0.7767627503052615,
    'loss_balancer_r': 0.92211247800681,
    'tf_pma_low': 8,
    'epochs': 569,
    'lr_mul': 0.059867144388605555,
    'n_warmup_steps': 474.32608422380395,
    'Optim': 'amsgradw',
    'non_role_model_mul': 1.8954636856544411,
    'adapter_loss_fn': 'mile',
    'fixed_role_model': 'tvae',
    'gradient_penalty_mode': 'NONE',
    'd_model': 256,
    'grad_clip': 0.7733939788275765,
    'bias': True,
    'bias_final': False,
