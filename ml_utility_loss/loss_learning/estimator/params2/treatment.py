...
PARAM_SPACE = {
    **DEFAULTS,
    ...
    "tf_num_inds": ("int_exp_2", 4, 128), #64
    #"tf_layer_norm": BOOLEAN,
    # Transformer PMA args
    "tf_pma_low": ("int_exp_2", 2, 32), #8
    ...
    # Head args
    "head_d_hid": ("int_exp_2", 32, 1024), #128
    "head_n_layers": ("int", 6, 10), #8
    "head_n_head": ("int_exp_2", 8, 128), #64
