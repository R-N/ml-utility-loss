...
PARAM_SPACE = {
    **DEFAULTS,
    ...
    "lr_mul": ("log_float", 0.25, 0.7),
    "n_warmup_steps": ("log_float", 180, 270),
    "Optim": ("optimizer", [
        # #"adamw", 
        # #"sgdmomentum", 
        "amsgradw",
    ...
    "loss_balancer_beta": ("float", 0.65, 0.7),
    "loss_balancer_r": ("float", 0.9, 0.93),
    ...
    "g_loss_mul": ("log_float", 0.05, 0.1),
    "non_role_model_mul": ("log_float", 1e-5, 1.0),
    #"mse_mag": ("conditional", {
    "mse_mag": True,
    "mse_mag_target": ("log_float", 0.65, 0.725),
    #}),
    ...
    "cos_loss": True,
    "cos_loss_target": ("log_float", 0.01, 0.02),
