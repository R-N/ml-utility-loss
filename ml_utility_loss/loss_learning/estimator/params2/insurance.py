...
PARAM_SPACE = {
    **DEFAULTS,
    ...
    # Transformer args
    "tf_d_inner": ("int_exp_2", 64, 2048), #256
    ...
    # Adapter args
    "ada_d_hid": ("int_exp_2", 128, 2048),  #256
    "ada_n_layers": ("int", 3, 10), #7
    ...
    # Head args
    "head_d_hid": ("int_exp_2", 8, 1024), 
    "head_n_layers": ("int", 4, 11), #9
